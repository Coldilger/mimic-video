"""Closed-loop entry point for Experiment 1 variant 1 (mimic-video, zero out).
Mirrors SimplerEnv/simpler_env/main_inference.py exactly, swapping in
VAMAblatedInference. Nothing under SimplerEnv/ is touched.
"""
